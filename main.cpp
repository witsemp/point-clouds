...
int main() {
    const std::string DATA_PATH_DEPTH(
            "/home/witsemp/work/24032021/toy_data/chair/1a74a83fa6d24b3cacd67ce2c72c02e/depth");
    ...
    PointCloud pcd(DATA_PATH_DEPTH, DATA_PATH_RGB, SAVE_PATH, TRANSFORMS_PATH, FAR_CLIPPING_PLANE, MAX_DEPTH, IMG_WIDTH,
                   IMG_HEIGHT, F_X,
                   F_Y, C_X, C_Y);
    pcl::PointCloud<pcl::PointXYZ> pointCloud = pcd.pointCloudFromDepth(idx);
    pcd.imageFromPointCloud(pointCloud, idx);
